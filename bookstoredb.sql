...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 16, 2023 lúc 12:12 PM
...
INSERT INTO `orders` (`orderID`, `address`, `created_at`, `name`, `note`, `phone`, `status`, `total_price`, `updated_at`, `userID`) VALUES
                                                                                                                                        (6, 'TP Hồ Chí Minh', '2023-04-15', NULL, 'abc', NULL, 'Đang xử lý..', 393000, NULL, 2),
                                                                                                                                        (7, 'TP Hồ Chí Minh', '2023-04-15', NULL, '', NULL, 'Đang xử lý..', 236000, NULL, 2),
                                                                                                                                        (8, 'Bình Dương', '2023-04-15', NULL, '', NULL, 'Đang xử lý..', 393000, NULL, 2);
...
INSERT INTO `users` (`userID`, `email`, `fullname`, `username`, `birthdate`, `gender`, `phone`, `password`, `avatar_path`, `status`, `confirm_token`, `is_enable`, `created_at`, `updated_at`) VALUES
                                                                                                                                                                                                   (1, 'camhong41201@gmail.com', 'Nguyen Van A', 'cmhg', '2023-04-15', b'1', '0783456781', '$2a$10$ZSJrWIVKH4xoBGNBKIF20uWkpTXsKvcR7nZMhXJYzIRe525tSGPLi', NULL, b'0', '349251', b'1', NULL, '2023-04-15'),
                                                                                                                                                                                                   (2, 'camhongdev@gmail.com', 'Nguyễn Tí Tò', 'tito', '2004-06-05', b'1', '0312312319', '$2a$10$3mqd.QRrtnWEzS/baMpSb.pggtq6tkO25bqjV18qJaJJJ90ZPFjkq', NULL, b'0', '337625', b'1', NULL, '2023-04-15'),
